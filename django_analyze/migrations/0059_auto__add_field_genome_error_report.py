...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genome.error_report'
        db.add_column(u'django_analyze_genome', 'error_report',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genome.error_report'
        db.delete_column(u'django_analyze_genome', 'error_report')
