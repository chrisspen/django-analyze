...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Epoche'
        db.create_table(u'django_analyze_epoche', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('genome', self.gf('django.db.models.fields.related.ForeignKey')(related_name='epoches', to=orm['django_analyze.Genome'])),
            ('index', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('min_fitness', self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True)),
            ('max_fitness', self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True)),
        ))
        db.send_create_signal('django_analyze', ['Epoche'])

        # Adding unique constraint on 'Epoche', fields ['genome', 'index']
        db.create_unique(u'django_analyze_epoche', ['genome_id', 'index'])

        # Adding field 'Genotype.epoche'
        db.add_column(u'django_analyze_genotype', 'epoche',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_analyze.Epoche'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Epoche', fields ['genome', 'index']
        db.delete_unique(u'django_analyze_epoche', ['genome_id', 'index'])

        # Deleting model 'Epoche'
        db.delete_table(u'django_analyze_epoche')

        # Deleting field 'Genotype.epoche'
        db.delete_column(u'django_analyze_genotype', 'epoche_id')
    ...
    models = {
        ...
        'django_analyze.genotype': {
            ...
            'epoche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['django_analyze.Epoche']", 'null': 'True', 'blank': 'True'}),
