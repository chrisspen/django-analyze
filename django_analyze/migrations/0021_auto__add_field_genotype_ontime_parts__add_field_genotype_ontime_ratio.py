...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.ontime_parts'
        db.add_column(u'django_analyze_genotype', 'ontime_parts',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Genotype.ontime_ratio'
        db.add_column(u'django_analyze_genotype', 'ontime_ratio',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.ontime_parts'
        db.delete_column(u'django_analyze_genotype', 'ontime_parts')

        # Deleting field 'Genotype.ontime_ratio'
        db.delete_column(u'django_analyze_genotype', 'ontime_ratio')
