...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gene.description'
        db.add_column(u'django_analyze_gene', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gene.description'
        db.delete_column(u'django_analyze_gene', 'description')
