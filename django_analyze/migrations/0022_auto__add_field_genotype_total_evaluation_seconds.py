...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.total_evaluation_seconds'
        db.add_column(u'django_analyze_genotype', 'total_evaluation_seconds',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.total_evaluation_seconds'
        db.delete_column(u'django_analyze_genotype', 'total_evaluation_seconds')
