...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.accuracy'
        db.add_column(u'django_analyze_genotype', 'accuracy',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.accuracy'
        db.delete_column(u'django_analyze_genotype', 'accuracy')
