...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Genotype.epoche'
        db.alter_column(u'django_analyze_genotype', 'epoche_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['django_analyze.Epoche']))
        # Adding field 'Genome.evolving'
        db.add_column(u'django_analyze_genome', 'evolving',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Genome.evolution_start_datetime'
        db.add_column(u'django_analyze_genome', 'evolution_start_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Genome._epoche'
        db.alter_column(u'django_analyze_genome', '_epoche_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['django_analyze.Epoche']))

    def backwards(self, orm):

        # Changing field 'Genotype.epoche'
        db.alter_column(u'django_analyze_genotype', 'epoche_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['django_analyze.Epoche']))
        # Deleting field 'Genome.evolving'
        db.delete_column(u'django_analyze_genome', 'evolving')

        # Deleting field 'Genome.evolution_start_datetime'
        db.delete_column(u'django_analyze_genome', 'evolution_start_datetime')


        # Changing field 'Genome._epoche'
        db.alter_column(u'django_analyze_genome', '_epoche_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['django_analyze.Epoche']))
