...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.export'
        db.add_column(u'django_analyze_genotype', 'export',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'GenotypeGene._value_genotype'
        db.add_column(u'django_analyze_genotypegene', '_value_genotype',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_analyze.Genotype'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.export'
        db.delete_column(u'django_analyze_genotype', 'export')

        # Deleting field 'GenotypeGene._value_genotype'
        db.delete_column(u'django_analyze_genotypegene', '_value_genotype_id')
    ...
    models = {
        ...
        'django_analyze.genome': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_fitness': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'max_memory_usage_ratio': ('django.db.models.fields.FloatField', [], {'default': '0.5'}),
        ...
        'django_analyze.genotype': {
            ...
            'export': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            ...
            'max_memory_usage': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'mean_memory_usage': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'django_analyze.genotypegene': {
            ...
            '_value_genotype': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['django_analyze.Genotype']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
