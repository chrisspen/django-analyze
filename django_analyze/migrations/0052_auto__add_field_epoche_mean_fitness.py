...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Epoche.mean_fitness'
        db.add_column(u'django_analyze_epoche', 'mean_fitness',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Epoche.mean_fitness'
        db.delete_column(u'django_analyze_epoche', 'mean_fitness')
