...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Genotype.fresh'
        db.alter_column(u'django_analyze_genotype', 'fresh', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Genotype.fresh'
        db.alter_column(u'django_analyze_genotype', 'fresh', self.gf('django.db.models.fields.NullBooleanField')(null=True))
