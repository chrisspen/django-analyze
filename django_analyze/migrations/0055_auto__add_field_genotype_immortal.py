...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.immortal'
        db.add_column(u'django_analyze_genotype', 'immortal',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.immortal'
        db.delete_column(u'django_analyze_genotype', 'immortal')
