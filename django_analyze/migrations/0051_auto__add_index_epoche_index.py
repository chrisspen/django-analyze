...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Epoche', fields ['index']
        db.create_index(u'django_analyze_epoche', ['index'])


    def backwards(self, orm):
        # Removing index on 'Epoche', fields ['index']
        db.delete_index(u'django_analyze_epoche', ['index'])
