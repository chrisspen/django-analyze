...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genome.elite_ratio'
        db.add_column(u'django_analyze_genome', 'elite_ratio',
                      self.gf('django.db.models.fields.FloatField')(default=0.1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genome.elite_ratio'
        db.delete_column(u'django_analyze_genome', 'elite_ratio')
