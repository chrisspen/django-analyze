...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genome.production_at_best'
        db.add_column(u'django_analyze_genome', 'production_at_best',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genome.production_at_best'
        db.delete_column(u'django_analyze_genome', 'production_at_best')
