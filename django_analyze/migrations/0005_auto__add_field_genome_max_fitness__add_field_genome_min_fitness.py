...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genome.max_fitness'
        db.add_column(u'django_analyze_genome', 'max_fitness',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Genome.min_fitness'
        db.add_column(u'django_analyze_genome', 'min_fitness',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genome.max_fitness'
        db.delete_column(u'django_analyze_genome', 'max_fitness')

        # Deleting field 'Genome.min_fitness'
        db.delete_column(u'django_analyze_genome', 'min_fitness')
