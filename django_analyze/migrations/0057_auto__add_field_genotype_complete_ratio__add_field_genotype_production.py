...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.complete_ratio'
        db.add_column(u'django_analyze_genotype', 'complete_ratio',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Genotype.production_complete_ratio'
        db.add_column(u'django_analyze_genotype', 'production_complete_ratio',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.complete_ratio'
        db.delete_column(u'django_analyze_genotype', 'complete_ratio')

        # Deleting field 'Genotype.production_complete_ratio'
        db.delete_column(u'django_analyze_genotype', 'production_complete_ratio')
