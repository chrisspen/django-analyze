...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Gene', fields ['coverage_ratio']
        db.create_index(u'django_analyze_gene', ['coverage_ratio'])


    def backwards(self, orm):
        # Removing index on 'Gene', fields ['coverage_ratio']
        db.delete_index(u'django_analyze_gene', ['coverage_ratio'])
