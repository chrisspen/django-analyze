...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.total_parts'
        db.add_column(u'django_analyze_genotype', 'total_parts',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Genotype.success_parts'
        db.add_column(u'django_analyze_genotype', 'success_parts',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Genotype.success_ratio'
        db.add_column(u'django_analyze_genotype', 'success_ratio',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.total_parts'
        db.delete_column(u'django_analyze_genotype', 'total_parts')

        # Deleting field 'Genotype.success_parts'
        db.delete_column(u'django_analyze_genotype', 'success_parts')

        # Deleting field 'Genotype.success_ratio'
        db.delete_column(u'django_analyze_genotype', 'success_ratio')
