...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.epoche_of_creation'
        db.add_column(u'django_analyze_genotype', 'epoche_of_creation',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.epoche_of_creation'
        db.delete_column(u'django_analyze_genotype', 'epoche_of_creation')
