...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Genotype.species'
        db.alter_column(u'django_analyze_genotype', 'species_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['django_analyze.Species']))
        # Adding index on 'Species', fields ['index']
        db.create_index(u'django_analyze_species', ['index'])

        # Adding index on 'Species', fields ['genome', 'index']
        db.create_index(u'django_analyze_species', ['genome_id', 'index'])


    def backwards(self, orm):
        # Removing index on 'Species', fields ['genome', 'index']
        db.delete_index(u'django_analyze_species', ['genome_id', 'index'])

        # Removing index on 'Species', fields ['index']
        db.delete_index(u'django_analyze_species', ['index'])


        # Changing field 'Genotype.species'
        db.alter_column(u'django_analyze_genotype', 'species_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['django_analyze.Species']))
