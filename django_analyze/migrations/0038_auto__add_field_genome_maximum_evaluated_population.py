...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genome.maximum_evaluated_population'
        db.add_column(u'django_analyze_genome', 'maximum_evaluated_population',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genome.maximum_evaluated_population'
        db.delete_column(u'django_analyze_genome', 'maximum_evaluated_population')
