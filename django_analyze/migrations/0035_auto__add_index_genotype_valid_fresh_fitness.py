...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Genotype', fields ['valid', 'fresh', 'fitness']
        db.create_index(u'django_analyze_genotype', ['valid', 'fresh', 'fitness'])


    def backwards(self, orm):
        # Removing index on 'Genotype', fields ['valid', 'fresh', 'fitness']
        db.delete_index(u'django_analyze_genotype', ['valid', 'fresh', 'fitness'])
