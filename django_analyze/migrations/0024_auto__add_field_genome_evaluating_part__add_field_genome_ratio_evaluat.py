...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genome.evaluating_part'
        db.add_column(u'django_analyze_genome', 'evaluating_part',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Genome.ratio_evaluated'
        db.add_column(u'django_analyze_genome', 'ratio_evaluated',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genome.evaluating_part'
        db.delete_column(u'django_analyze_genome', 'evaluating_part')

        # Deleting field 'Genome.ratio_evaluated'
        db.delete_column(u'django_analyze_genome', 'ratio_evaluated')
