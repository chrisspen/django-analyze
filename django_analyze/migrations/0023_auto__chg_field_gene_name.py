...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'django_analyze_gene', 'name', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Gene.name'
        db.alter_column(u'django_analyze_gene', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
