...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.memory_usage_samples'
        db.add_column(u'django_analyze_genotype', 'memory_usage_samples',
                      self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Genotype.mean_memory_usage'
        db.add_column(u'django_analyze_genotype', 'mean_memory_usage',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.memory_usage_samples'
        db.delete_column(u'django_analyze_genotype', 'memory_usage_samples')

        # Deleting field 'Genotype.mean_memory_usage'
        db.delete_column(u'django_analyze_genotype', 'mean_memory_usage')
