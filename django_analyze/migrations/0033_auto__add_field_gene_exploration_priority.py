...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gene.exploration_priority'
        db.add_column(u'django_analyze_gene', 'exploration_priority',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gene.exploration_priority'
        db.delete_column(u'django_analyze_gene', 'exploration_priority')
