...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genome._epoche'
        db.add_column(u'django_analyze_genome', '_epoche',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='current_genome', null=True, to=orm['django_analyze.Epoche']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genome._epoche'
        db.delete_column(u'django_analyze_genome', '_epoche_id')
    ...
    models = {
        ...
        'django_analyze.genome': {
            ...
            '_epoche': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'current_genome'", 'null': 'True', 'to': "orm['django_analyze.Epoche']"}),
        ...
        'django_analyze.genotype': {
            ...
            'epoche': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'genotypes'", 'null': 'True', 'to': "orm['django_analyze.Epoche']"}),
