...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.index'
        db.add_column(u'django_analyze_species', 'index',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'Species', fields ['genome', 'index']
        db.create_unique(u'django_analyze_species', ['genome_id', 'index'])


    def backwards(self, orm):
        # Removing unique constraint on 'Species', fields ['genome', 'index']
        db.delete_unique(u'django_analyze_species', ['genome_id', 'index'])

        # Deleting field 'Species.index'
        db.delete_column(u'django_analyze_species', 'index')
    ...
    models = {
        ...
        'django_analyze.genotype': {
            ...
            'species': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'genotypes'", 'null': 'True', 'to': "orm['django_analyze.Species']"}),
        ...
        'django_analyze.species': {
            'Meta': {'unique_together': "(('genome', 'index'),)", 'object_name': 'Species'},
