...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.centroid'
        db.add_column(u'django_analyze_species', 'centroid',
                      self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Species.centroid'
        db.delete_column(u'django_analyze_species', 'centroid')
