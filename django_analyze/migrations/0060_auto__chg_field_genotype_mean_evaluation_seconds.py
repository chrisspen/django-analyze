...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Genotype.mean_evaluation_seconds'
        db.alter_column(u'django_analyze_genotype', 'mean_evaluation_seconds', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Genotype.mean_evaluation_seconds'
        db.alter_column(u'django_analyze_genotype', 'mean_evaluation_seconds', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'django_analyze.genestatistics': {
            ...
            'gene': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['django_analyze.Gene']", 'db_column': "'gene_id'"}),
            'genome': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'gene_statistics'", 'db_column': "'genome_id'", 'to': "orm['django_analyze.Genome']"}),
