...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Genotype', fields ['genome', 'fresh']
        db.create_index(u'django_analyze_genotype', ['genome_id', 'fresh'])


    def backwards(self, orm):
        # Removing index on 'Genotype', fields ['genome', 'fresh']
        db.delete_index(u'django_analyze_genotype', ['genome_id', 'fresh'])
