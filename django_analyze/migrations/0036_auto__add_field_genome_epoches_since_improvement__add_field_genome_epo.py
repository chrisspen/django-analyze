...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genome.epoches_since_improvement'
        db.add_column(u'django_analyze_genome', 'epoches_since_improvement',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Genome.epoche_stall'
        db.add_column(u'django_analyze_genome', 'epoche_stall',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genome.epoches_since_improvement'
        db.delete_column(u'django_analyze_genome', 'epoches_since_improvement')

        # Deleting field 'Genome.epoche_stall'
        db.delete_column(u'django_analyze_genome', 'epoche_stall')
    ...
    models = {
        ...
        'django_analyze.genotype': {
            'Meta': {'ordering': "('-fitness',)", 'unique_together': "(('genome', 'fingerprint'),)", 'object_name': 'Genotype', 'index_together': "(('valid', 'fresh', 'fitness'),)"},
