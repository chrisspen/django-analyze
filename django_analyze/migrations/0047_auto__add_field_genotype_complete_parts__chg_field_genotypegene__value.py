...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.complete_parts'
        db.add_column(u'django_analyze_genotype', 'complete_parts',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'GenotypeGene._value_genome'
        db.alter_column(u'django_analyze_genotypegene', '_value_genome_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_analyze.Genome'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'Genotype.complete_parts'
        db.delete_column(u'django_analyze_genotype', 'complete_parts')


        # Changing field 'GenotypeGene._value_genome'
        db.alter_column(u'django_analyze_genotypegene', '_value_genome_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_analyze.Genome'], null=True))
