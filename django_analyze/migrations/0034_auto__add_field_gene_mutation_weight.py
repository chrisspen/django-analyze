...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gene.mutation_weight'
        db.add_column(u'django_analyze_gene', 'mutation_weight',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gene.mutation_weight'
        db.delete_column(u'django_analyze_gene', 'mutation_weight')
