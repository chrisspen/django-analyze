...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.evaluating_pid'
        db.add_column(u'django_analyze_genotype', 'evaluating_pid',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.evaluating_pid'
        db.delete_column(u'django_analyze_genotype', 'evaluating_pid')
