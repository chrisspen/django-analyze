...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gene.dependee_gene'
        db.add_column(u'django_analyze_gene', 'dependee_gene',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dependent_genes', null=True, to=orm['django_analyze.Gene']),
                      keep_default=False)

        # Adding field 'Gene.dependee_value'
        db.add_column(u'django_analyze_gene', 'dependee_value',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gene.dependee_gene'
        db.delete_column(u'django_analyze_gene', 'dependee_gene_id')

        # Deleting field 'Gene.dependee_value'
        db.delete_column(u'django_analyze_gene', 'dependee_value')
