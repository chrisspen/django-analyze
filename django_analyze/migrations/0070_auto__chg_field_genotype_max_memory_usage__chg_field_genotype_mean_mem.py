...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Genotype.max_memory_usage'
        db.alter_column(u'django_analyze_genotype', 'max_memory_usage', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Genotype.mean_memory_usage'
        db.alter_column(u'django_analyze_genotype', 'mean_memory_usage', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Genotype.max_memory_usage'
        db.alter_column(u'django_analyze_genotype', 'max_memory_usage', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Genotype.mean_memory_usage'
        db.alter_column(u'django_analyze_genotype', 'mean_memory_usage', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
