...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.description'
        db.add_column(u'django_analyze_genotype', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.description'
        db.delete_column(u'django_analyze_genotype', 'description')
