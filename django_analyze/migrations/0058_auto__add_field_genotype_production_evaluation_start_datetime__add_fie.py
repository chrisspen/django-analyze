...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.production_evaluation_start_datetime'
        db.add_column(u'django_analyze_genotype', 'production_evaluation_start_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Genotype.production_evaluation_end_datetime'
        db.add_column(u'django_analyze_genotype', 'production_evaluation_end_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Genome.production_evaluation_timeout'
        db.add_column(u'django_analyze_genome', 'production_evaluation_timeout',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.production_evaluation_start_datetime'
        db.delete_column(u'django_analyze_genotype', 'production_evaluation_start_datetime')

        # Deleting field 'Genotype.production_evaluation_end_datetime'
        db.delete_column(u'django_analyze_genotype', 'production_evaluation_end_datetime')

        # Deleting field 'Genome.production_evaluation_timeout'
        db.delete_column(u'django_analyze_genome', 'production_evaluation_timeout')
