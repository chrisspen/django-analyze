...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.generation'
        db.add_column(u'django_analyze_genotype', 'generation',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.generation'
        db.delete_column(u'django_analyze_genotype', 'generation')
