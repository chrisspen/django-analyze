...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genome.production_genotype_auto'
        db.add_column(u'django_analyze_genome', 'production_genotype_auto',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Genome.production_genotype'
        db.add_column(u'django_analyze_genome', 'production_genotype',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='production_genomes', null=True, on_delete=models.SET_NULL, to=orm['django_analyze.Genotype']),
                      keep_default=False)

        # Adding field 'Genotype.fresh_datetime'
        db.add_column(u'django_analyze_genotype', 'fresh_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genome.production_genotype_auto'
        db.delete_column(u'django_analyze_genome', 'production_genotype_auto')

        # Deleting field 'Genome.production_genotype'
        db.delete_column(u'django_analyze_genome', 'production_genotype_id')

        # Deleting field 'Genotype.fresh_datetime'
        db.delete_column(u'django_analyze_genotype', 'fresh_datetime')
