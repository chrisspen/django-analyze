...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genome.max_species'
        db.add_column(u'django_analyze_genome', 'max_species',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genome.max_species'
        db.delete_column(u'django_analyze_genome', 'max_species')
