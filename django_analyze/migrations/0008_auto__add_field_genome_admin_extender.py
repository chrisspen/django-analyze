...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genome.admin_extender'
        db.add_column(u'django_analyze_genome', 'admin_extender',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genome.admin_extender'
        db.delete_column(u'django_analyze_genome', 'admin_extender')
