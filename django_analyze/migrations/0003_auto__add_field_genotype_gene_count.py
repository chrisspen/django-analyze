...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.gene_count'
        db.add_column(u'django_analyze_genotype', 'gene_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.gene_count'
        db.delete_column(u'django_analyze_genotype', 'gene_count')
