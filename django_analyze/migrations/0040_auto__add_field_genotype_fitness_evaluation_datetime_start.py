...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.fitness_evaluation_datetime_start'
        db.add_column(u'django_analyze_genotype', 'fitness_evaluation_datetime_start',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.fitness_evaluation_datetime_start'
        db.delete_column(u'django_analyze_genotype', 'fitness_evaluation_datetime_start')
