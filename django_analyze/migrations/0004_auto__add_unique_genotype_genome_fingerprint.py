...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Genotype', fields ['genome', 'fingerprint']
        db.create_unique(u'django_analyze_genotype', ['genome_id', 'fingerprint'])


    def backwards(self, orm):
        # Removing unique constraint on 'Genotype', fields ['genome', 'fingerprint']
        db.delete_unique(u'django_analyze_genotype', ['genome_id', 'fingerprint'])
