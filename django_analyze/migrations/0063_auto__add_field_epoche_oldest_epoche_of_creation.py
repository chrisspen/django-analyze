...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Epoche.oldest_epoche_of_creation'
        db.add_column(u'django_analyze_epoche', 'oldest_epoche_of_creation',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Epoche.oldest_epoche_of_creation'
        db.delete_column(u'django_analyze_epoche', 'oldest_epoche_of_creation')
