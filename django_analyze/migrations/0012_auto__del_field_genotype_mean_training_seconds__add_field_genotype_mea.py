...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Genotype.mean_training_seconds'
        db.delete_column(u'django_analyze_genotype', 'mean_training_seconds')

        # Adding field 'Genotype.mean_evaluation_seconds'
        db.add_column(u'django_analyze_genotype', 'mean_evaluation_seconds',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Genotype.mean_absolute_error'
        db.add_column(u'django_analyze_genotype', 'mean_absolute_error',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Genotype.mean_training_seconds'
        db.add_column(u'django_analyze_genotype', 'mean_training_seconds',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Genotype.mean_evaluation_seconds'
        db.delete_column(u'django_analyze_genotype', 'mean_evaluation_seconds')

        # Deleting field 'Genotype.mean_absolute_error'
        db.delete_column(u'django_analyze_genotype', 'mean_absolute_error')
    ...
    models = {
        ...
        u'django_analyze.genotype': {
            ...
            'fresh': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
