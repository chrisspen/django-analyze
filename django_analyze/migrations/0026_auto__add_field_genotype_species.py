...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.species'
        db.add_column(u'django_analyze_genotype', 'species',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='genotypes', null=True, to=orm['django_analyze.Species']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.species'
        db.delete_column(u'django_analyze_genotype', 'species_id')
