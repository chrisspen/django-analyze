...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genotype.valid'
        db.add_column(u'django_analyze_genotype', 'valid',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)

        # Adding field 'Genotype.error'
        db.add_column(u'django_analyze_genotype', 'error',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genotype.valid'
        db.delete_column(u'django_analyze_genotype', 'valid')

        # Deleting field 'Genotype.error'
        db.delete_column(u'django_analyze_genotype', 'error')
